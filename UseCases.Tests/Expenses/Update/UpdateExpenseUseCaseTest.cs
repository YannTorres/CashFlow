...
public class UpdateExpenseUseCaseTest
{
    ...
    public async Task Sucess()
    {
        ...
        var act = async () => await useCase.Execute(expense.Id, request); // execute nao devolve nenhum valor.
    ...
    public async Task Expense_Not_Found()
    {
        ...
        var act = async () => await useCase.Execute(id: 1000000000, request);
    ...
    {
        var repository = new ExpensesUpdateOnlyRepositoryBuilder().GetById(expense).Build();
